...
prioQ *makePrioQ(int num_vertices) {
  ...
  // Initialize key values within the priority queue structure
...
void prim(int start, uwu *graph, int N) {
  long long *distances = malloc(N * sizeof(int));
